          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                pattern="[0-9]{10}"
              />
              <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-indigo-600" size={20} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="********"
              />
              <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-indigo-600" size={20} />
            </div>
          </div>
        </div>
