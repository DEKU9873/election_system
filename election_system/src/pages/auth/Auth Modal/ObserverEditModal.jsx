...
const ObserverEditModal = ({ onClose, userData }) => {
  ...
  const [
    ...
    // الحالات الخاصة بالناخبين (غير مستخدمة هنا)
    hasVotingRight,
    idUpdated,
    // معالجات الأحداث
    ...
    // حالة التحميل
    isLoading,
  ] = useEditUser(userData, onClose, "observer");

  // تم نقل دالة handleSubmit إلى هوك edit-user-hook
...
export default ObserverEditModal;