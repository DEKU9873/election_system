...
const CoordinatorRegisterModal = ({ onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white backdrop-blur-sm p-6 rounded-2xl shadow-2xl w-full max-w-5xl flex flex-col items-center relative max-h-[90vh] overflow-y-auto my-8 scrollbar-right"
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-center text-gray-800">تسجيل مرتكز جديد</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 w-full">
          ...
          <div className="space-y-4 w-full">
            <h3 className="text-xl font-semibold text-gray-700 mb-4 text-right">المراكز الانتخابية</h3>
            <div className="relative">
